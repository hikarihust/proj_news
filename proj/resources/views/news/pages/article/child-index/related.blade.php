...
<div class="post_item post_h_large">
    <div class="row">
        <div class="col-lg-5">
            <div class="post_image"><img src="{{ asset('images/article/e7YyFZJCc8.jpeg') }}" alt="images/article/e7YyFZJCc8.jpeg"
                ...
                <div class="post_info d-flex flex-row align-items-center justify-content-start">
                    <div class="post_author d-flex flex-row align-items-center justify-content-start">
                        <div class="post_author_name"><a
                                href="bai-viet/man-city-van-du-champions-league-mua-2019-2020-15.html#">Vu
                                Quang</a></div>
                    </div>
