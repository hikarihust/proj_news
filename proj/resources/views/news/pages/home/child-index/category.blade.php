            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="post_image"><img src="{{ asset('news/images/article/e7YyFZJCc8.jpeg') }}"
                            alt="images/article/e7YyFZJCc8.jpeg" class="img-fluid w-100"></div>
                </div>
                <div class="col-lg-7">
                    <div class="post_content">
                        ...
                        <div class="post_title"><a href="bai-viet/ha-noi-vao-vong-knock-out-afc-cup-14.html">Hà Nội
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="post_image"><img src="{{ asset('news/images/article/exzJEG4WDU.jpeg') }}"
                            alt="images/article/exzJEG4WDU.jpeg" class="img-fluid w-100"></div>
                </div>
                <div class="col-lg-7">
                    <div class="post_content">
                        <div class="post_category cat_technology ">
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="post_image"><img src="{{ asset('news/images/article/TpcocqUjob.png') }}"
                            alt="images/article/TpcocqUjob.png" class="img-fluid w-100"></div>
                </div>
                <div class="col-lg-7">
                    <div class="post_content">
                        <div class="post_category cat_technology ">
                        ...
                        <div class="post_title"><a href="bai-viet/nhung-cau-do-giup-ren-luyen-tri-nao-16.html">Những
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="post_image"><img src="{{ asset('news/images/article/L3Yuzln8II.png') }}"
                            alt="images/article/L3Yuzln8II.png" class="img-fluid w-100"></div>
                </div>
                <div class="col-lg-7">
                    <div class="post_content">
                        <div class="post_category cat_technology ">
                ...
                <div class="col-lg-6">
                    <div class="post_item post_v_small d-flex flex-column align-items-start justify-content-start">
                        <div class="post_image"><img src="{{ asset('news/images/article/nt1QxhKUXM.jpeg') }}"
                                alt="images/article/nt1QxhKUXM.jpeg" class="img-fluid w-100"></div>
                        <div class="post_content">
                            <div class="post_category cat_technology ">
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="post_image"><img src="{{ asset('news/images/article/g2c7mYXBPW.png') }}"
                            alt="images/article/g2c7mYXBPW.png" class="img-fluid w-100"></div>
                </div>
                <div class="col-lg-7">
                    <div class="post_content">
                        <div class="post_category cat_technology ">
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="post_image"><img src="{{ asset('news/images/article/9fbeUKTBpU.png') }}"
                            alt="images/article/9fbeUKTBpU.png" class="img-fluid w-100"></div>
                </div>
                <div class="col-lg-7">
                    <div class="post_content">
                        <div class="post_category cat_technology ">
