...
-- Records of category
-- ----------------------------
INSERT INTO `category` VALUES (1, 'Thể thao', 'active', '2019-05-04 00:00:00', 'admin', '2019-05-12 00:00:00', 'quangvu', 1, 'list');
INSERT INTO `category` VALUES (2, 'Giáo dục', 'active', '2019-05-04 00:00:00', 'admin', '2019-05-12 00:00:00', 'quangvu', 1, 'grid');
INSERT INTO `category` VALUES (3, 'Sức khỏe', 'active', '2019-05-04 00:00:00', 'admin', '2019-05-15 15:04:33', 'quangvu', 0, 'list');
INSERT INTO `category` VALUES (4, 'Du lịch', 'active', '2019-05-04 00:00:00', 'admin', '2019-05-15 15:04:30', 'quangvu', 0, 'grid');
INSERT INTO `category` VALUES (5, 'Khoa học', 'active', '2019-05-04 00:00:00', 'admin', '2019-05-12 00:00:00', 'quangvu', 0, 'list');
INSERT INTO `category` VALUES (6, 'Số hóa', 'active', '2019-05-04 00:00:00', 'admin', '2019-05-15 15:04:38', 'quangvu', 1, 'grid');
INSERT INTO `category` VALUES (7, 'Xe - Ô tô', 'active', '2019-05-04 00:00:00', 'admin', '2019-05-15 15:04:36', 'quangvu', 1, 'list');
INSERT INTO `category` VALUES (8, 'Kinh doanh', 'active', '2019-05-12 00:00:00', 'quangvu', NULL, NULL, 0, 'list');
...
-- Records of slider
-- ----------------------------
INSERT INTO `slider` VALUES (1, 'Khóa học lập trình Frontend Master', 'Khóa học sẽ giúp bạn trở thành một chuyên gia Frontend với đầy đủ các kiến thức về HTML, CSS, JavaScript, Bootstrap, jQuery, chuyển PSD thành HTML ...', 'https://zendvn.com/khoa-hoc-lap-trinh-frontend-master/', 'rEpDUQCxe4.jpeg', '2019-04-15 00:00:00', 'quangvu', '2019-04-24 13:28:03', 'quangvu', 'active');
INSERT INTO `slider` VALUES (2, 'Học lập trình trực tuyến', 'Học trực tuyến giúp bạn tiết kiệm chi phí, thời gian, cập nhật được nhiều kiến thức mới nhanh nhất và hiệu quả nhất', 'https://zendvn.com/', 'K6B1O6UNCb.jpeg', '2019-04-18 00:00:00', 'quangvu', '2019-04-24 13:28:06', 'quangvu', 'active');
INSERT INTO `slider` VALUES (3, 'Ưu đãi học phí', 'Tổng hợp các trương trình ưu đãi học phí hàng tuần, hàng tháng đến tất các các bạn với các mức giảm đặc biệt 50%, 70%,..', 'https://zendvn.com/uu-dai-hoc-phi-tai-zendvn/', 'LWi6hINpXz.jpeg', '2019-04-24 00:00:00', 'quangvu', '2019-04-24 13:28:09', NULL, 'active');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'admin', 'admin@gmail.com', 'admin123456', 'e10adc3949ba59abbe56e057f20f883e', '1ctW8mj8vq.png', 'admin', '2014-12-10 08:55:35', 'admin', '2019-05-04 14:47:14', 'quangvu', 'active');
INSERT INTO `user` VALUES (2, 'quangvu', 'quangvu@gmail.com', 'quangvu', '7c6f3ef49405d8a330aaa19ca0d0f6af', '1eSGmvZ3gM.jpeg', 'member', '2014-12-13 07:20:03', 'admin', '2019-05-04 08:47:04', 'quangvu', 'active');
INSERT INTO `user` VALUES (3, 'user123', 'test@gmail.com', 'user123', 'e10adc3949ba59abbe56e057f20f883e', 'Hb1QSn1CL8.png', 'member', '2019-05-04 00:00:00', 'admin', '2019-05-04 08:47:07', 'quangvu', 'inactive');
INSERT INTO `user` VALUES (4, 'user456', 'user456@gmail.com', 'user456', 'e10adc3949ba59abbe56e057f20f883e', 'J1uknUz0T6.png', 'member', '2019-05-04 00:00:00', 'admin', '2019-05-04 08:47:10', 'quangvu', 'inactive');
